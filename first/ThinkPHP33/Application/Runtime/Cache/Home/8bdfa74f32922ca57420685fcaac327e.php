...
<div style="width: 1200px;height:500px;margin: 0 auto;background:red;">
     ...
     <div style="width: 70%;height: 500px;background: blue;display: inline;float: left;">
       ...
       <div style="width: 99%;height: 300px;background:green;overflow: scroll;">
            <ul>
              <?php if(is_array($msg)): $i = 0; $__LIST__ = $msg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><li><?php echo (strip_tags($arr["content"])); ?>--<?php echo ($arr["uname"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>  
               f
               <?php if(is_array($msg)): foreach($msg as $key=>$arr): ?><li><?php echo (mb_substr(strip_tags($arr['content']),0,50,"utf-8")); ?>--<?php echo ($arr["uname"]); ?></li><br /><?php endforeach; endif; ?> 
           </ul>
       </div>
     </div>
